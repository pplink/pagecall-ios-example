...
MediaDevices.prototype.getUserMedia = function (constraints) {
    debug('MediaDevices.prototype.getUserMedia invoke');
	return getUserMedia(constraints);
};

MediaDevices.prototype.enumerateDevices = function () {
    debug('MediaDevices.prototype.enumerateDevices invoke');
...
function restoreCallbacksSupport() {
    ...
    debug('callbackifyMethod getUserMedia');
	getUserMedia = callbackifyMethod(getUserMedia);
    debug('callbackifyMethod enumerateDevices()');
	enumerateDevices = callbackifyMethod(enumerateDevices);
    
    debug('RTCPeerConnection callbackifyPrototype');
